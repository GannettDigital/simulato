...
module.exports = saucelabs = {
  connect(callback) {
    ...
    sauceConnectLauncher({
      username: configHandler.get('driver.username') || process.env.SAUCE_USERNAME,
      accessKey: configHandler.get('driver.accessKey') || process.env.SAUCE_ACCESS_KEY,
      tunnelIdentifier: configHandler.get('driver.tunnelIdentifier'),
