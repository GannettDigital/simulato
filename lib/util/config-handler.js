...
module.exports = configHandler = {
  ...
  createConfig(cliOptions) {
    ...
    configHandler._getBaseConfig(cliOptions.opts(), function(configFile) {
      ...
      if (configHandler._config.saucelabs) {
  ...
  _resolvePaths() {
    ...
    if (configHandler._config.customReporteportPath) {
      configHandler._config.customReporteportPath = path.resolve(configHandler._config.customReporteportPath);
    }
