...
module.exports = function(files, callback) {
  ...
  for (const file of files) {
    ...
    if (typeof component !== 'object' || Array.isArray(component)) {
      throw new SimulatoError.COMPONENT.COMPONENT_TYPE_ERROR(`The component at file path '${file}' must be an object`);
    }
    if (typeof component.type !== 'string') {
      throw new SimulatoError.COMPONENT.COMPONENT_TYPE_ERROR(
          `The component at file path '${file}' must have a string for type property`,
      );
    }
    if (component.entryComponent) {
      const entryComponent = component.entryComponent;
