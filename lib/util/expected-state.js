...
module.exports = ExpectedState = {
  create(dataStore, callback) {
    ...
    // TODO: Add pop count for planner
    // TODO: Add clonedStashedStates for planner

    // When i stash, set popCount to 0, every pop increment popcount. Know what to do stateCompare against bassed on pop count
