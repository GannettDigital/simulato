...
module.exports = function(plannerEventDispatch) {
    ...
    plannerEventDispatch.on('hillClimbing.calculateActionCounts', countActions.calculate);
    plannerEventDispatch.on('hillClimbing.cloneSearchNode', searchNode.clone);
    plannerEventDispatch.on('hillClimbing.applyEffects', applyEffects);
    plannerEventDispatch.on('hillClimbing.planningFinished', writePlansToDisk);
    plannerEventDispatch.on('hillClimbing.planningFinished', actionCoverage.calculate);
