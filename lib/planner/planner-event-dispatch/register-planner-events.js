...
module.exports = function(plannerEventDispatch) {
  ...
  plannerEventDispatch.runOn('testPlanner.createActionTreePlans', actionTree.createPlans);
  plannerEventDispatch.runOn('testPlanner.createForwardStateSpaceSearchHeuristicPlans', forwardStateSpaceSearch.createPlans);
