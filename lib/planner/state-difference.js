...
// Code from https://stackoverflow.com/questions/33232823/how-to-compare-two-objects-and-get-key-value-pairs-of-their-differences
module.exports = stateDiff = {
  createDiff(oldState = {}, newState = {}, callback) {
    // return callback(null, stateDiff._merge(
    //   // stateDiff._diff(oldState, newState, "oldState"),
