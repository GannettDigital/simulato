...
module.exports = actionTree = {
  ...
  * _processAction(component, actionName, parentNode, callback) {
    ...
    if (!actionTree._visitedActions.has(actionIdentifier)) {
      ...
      actionTree._discoveredActions.set(actionIdentifier, actionNodePreconditions);
  ...
  _addToPreconMap(actionNode, precondition) {
    ...
    let nodesToMeetPrecon = actionTree._getNodesToMeetPrecondition(precondition.dataSet, precondition.key, precondition.value);
