...
module.exports = function(executorEventDispatch) {
  ...
  executorEventDispatch.on('executeTestCase.driverSetToSauce', driverHandler.inSaucelabs);
  executorEventDispatch.on('executeTestCase.driverSetToLocal', driverHandler.locally);
  ...
  executorEventDispatch.on('assertionHandler.stateCheckTimedOut', stateCompare.printDifference);
  ...
  executorEventDispatch.on('stateCompare.differenceCreated', eeReportHandler.appendStateCompare);
};
