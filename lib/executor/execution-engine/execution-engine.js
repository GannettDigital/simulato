...
module.exports = executionEngine = {
    ...
    configure(testCaseActions) {
        ...
        executionEngine.emitAsync('executionEngine.createDataStore', function(dataStore) {
            executionEngine._dataStore = dataStore;
            executionEngine.emitAsync('executionEngine.createExpectedState', executionEngine._dataStore,
    ...
    _executeStep() {
        ...
        executionEngine.emitAsync('executionEngine.stepStarted', executionEngine._step);
