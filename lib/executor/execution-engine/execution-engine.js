...
module.exports = executionEngine = {
    ...
    executionEngine.emitAsync('dataStore.create', function(dataStore) {
      ...
      executionEngine.emitAsync('expectedState.create', executionEngine._dataStore,
          function(expectedState) {
            ...
            const {type, name, state, options} = executionEngine._actionList.shift();
  ...
  _executeNextAction() {
    ...
    const actionObject = executionEngine._actionList.shift();
    const [name, actionName] = actionObject.name.split('.');
    executionEngine._actionConfig = {name, actionName, options: actionObject.options};
    const components = executionEngine._expectedState.getComponentsAsMap();
  ...
  _executeStep() {
    ...
    const component = executionEngine._expectedState.getComponentsAsMap()
  ...
  applyPreconditions() {
    ...
    const component = executionEngine._expectedState.getComponent(executionEngine._actionConfig.name);
