...
module.exports = executionEngine = {
    ...
    _executeNextAction() {
        ...
        let actionIdentifier = executionEngine._actionList.shift();
        let [name, actionName] = actionIdentifier.name.split('.');
        executionEngine._actionConfig = {name, actionName};
            ...
            case 'preconditions':
                executionEngine.emit(
                    ...
                    function(error) {
                        ...
                        try {
                            if (actionParameters) {
                                component.actions[executionEngine._actionConfig.actionName].preconditions.call(
                                    component,
                                    ...executionEngine._actionParameters,
                                    executionEngine._dataStore
                                );
                            } else {
                                component.actions[executionEngine._actionConfig.actionName].preconditions.call(
                            ...
                            err.message = `The error '${err.message}' was thrown while ` +
            ...
            executionEngine.emit(
                ...
                function(error) {
                    ...
                    try {
                        ...
                        if (actionParameters) {
                            component.actions[executionEngine._actionConfig.actionName].effects.call(
                                component,
                                ...actionParameters,
                                executionEngine._expectedState,
                                executionEngine._dataStore
