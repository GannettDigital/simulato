...
module.exports = testReportHandler = {
  ...
  appendTestStdErr(stdErr, testNumber) {
    const testReport = testReportHandler._report.testReports[testNumber];
    const testRun = testReport.testRuns[testReport.rerunCount];
  ...
  _printFailedReports() {
    for (const report of testReportHandler._failedReports) {
