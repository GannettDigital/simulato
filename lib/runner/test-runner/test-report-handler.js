...
module.exports = testReportHandler = {
  ...
  _handleTestReportSummary() {
    ...
    if (configHandler.get('reportPath') || configHandler.get('customReportPath')) {
      switch (configHandler.get('reportFormat')) {
        case 'JSON':
          ...
          testReportHandler.emit('testReportHandler.customTestReportSummaryReadyToWrite', 'customReport', testReportHandler._report);
      }
    }
  },
};
